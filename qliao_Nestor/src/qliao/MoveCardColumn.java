...
/**
 * MoveCardColumn move the top card of the reserves pile to Column to match and remove the cards
 * 
 * @author Qiaoyu Liao (qliao@wpi.edu)
 *
 */
public class MoveCardColumn extends Move {
	...
	public MoveCardColumn(Deck deck, BuildablePile from, Card movingCard, Column to){
		this.deck = deck;
		this.from = from;
